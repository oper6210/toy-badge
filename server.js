...
app.post("/badge", upload.single("image"), async (req, res) => {
  try {
    ...
    const gitImageUrl = `https://github.com/oper6210/image/blob/main/${req.file.originalname}?raw=true`;    //metadata 의 imageUrl을 구글 클라우드 스토리지에서 들고오면 이미지가 안보여서 git에 하드코딩함
